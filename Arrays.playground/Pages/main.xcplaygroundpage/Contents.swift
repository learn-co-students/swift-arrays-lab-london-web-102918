 ...
 */
// write your code here
    func lifeEssential(array: [String]) -> Bool {
        if(array[0] == "Bread") {
            return true
        }
            return false
    ...
    print(lifeEssential(array: ["Bread"," Sugar", "Salt"]))
 ...
 */
// write your code here
    print(lifeEssential(array: shoppingList))
 ...
 */
// write your code here
    print(lifeEssential(array: dessertList))
